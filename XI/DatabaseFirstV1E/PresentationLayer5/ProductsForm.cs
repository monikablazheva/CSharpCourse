...
namespace PresentationLayer5
{
    ...
    {
        private DBManager<Product, string> dBManager;
        ...
        public ProductsForm()
        {
            ...
            dBManager = new DBManager<Product, string>(DBContextManager.CreateProductContext(DBContextManager.CreateContext()));
        ...
        private void updateBtn_Click(object sender, EventArgs e)
        {
            try
            {
                if (ValidateData())
                {
                    ...
                    dBManager.Update(selectedProduct);
        ...
        private void deleteBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    dBManager.Delete(selectedProduct.Barcode);
        ...
        private void productsDataGridView_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex != -1 && e.ColumnIndex != -1)
            {
                ...
                selectedProduct = new Product(barcode, name, brand, quantity, price);
